...
<?php echo W('PageHeader',array('name'=>'请选择父节点','search'=>'N'));?>
<div class="operate panel panel-default">
	...
	<div class="popup_tree_menu panel-body">
		<ul class="tree_menu">
			<li>
	...
	<script type="text/javascript">
		function save() {
			if ($("#name").val().length > 0) {
				$("#folder_name", parent.document).val($("#name").val());
		...
		$(document).ready(function() {
			...
			$("ul.tree_menu a[node='" + parent_node + "']").parent().hide();
