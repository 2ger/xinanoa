...
<?php echo W('PageHeader',array('name'=>'新建文档','search'=>'N'));?>
...
<form method='post' id="form_data" name="form_data" enctype="multipart/form-data"   class="well form-horizontal">
	...
	<input type="hidden" id="fid" name="fid" value="<?php echo ($folder); ?>">
	<input type="hidden" id="opmode" name="opmode" value="add">

	<div class="form-group">
		<label class="col-sm-2 control-label" for="name">文件名：</label>
		<div class="col-sm-10">
			<input class="form-control" type="text" id="name" name="name" value="<?php echo ($vo["name"]); ?>"  check="require" msg="请输入文件名">
		</div>
	</div>
	...
	<div class="form-group">
		<div class="col-xs-12">
			<textarea class="editor" id="content" name="content" style="width:100%;height:300px;" check="require" msg="请输入内容"><?php echo ($vo["content"]); ?></textarea>
		</div>
	</div>
	<div class="action">
