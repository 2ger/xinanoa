...
<body>
	...
	<nav class="navbar navbar-default " role="navigation">
		...
		<button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#navbar-collapse-6">
          ...
          <a href="<?php echo U('home/index');?>" class="navbar-brand"><?php echo get_system_config("SYSTEM_NAME");?></a>
          <a class="" href="#" url="/liucheng/index.php?m=flow&amp;a=index" node="87" onclick="click_top_menu(this)">
				流程																
				</a> / 
...
<form method="post" action="" id="form_search" name="form_search">
	<?php echo W('PageHeader',array('name'=>'系统信息','search'=>'N'));?>
	...
	<div class="row ">
		<div class="row form-horizontal">
			<div class="form-group col-xs-12">
				<label class="col-sm-2 control-label">域名\主机名：</label>
				<div class="col-sm-10 "><p class="form-control-static"><?php echo ($SERVER_NAME); ?></p>
				</div>
			</div>
			<div class="form-horizontal">
				<div class="form-group col-xs-12">
					...
					<div class="col-sm-10 ">
						<p class="form-control-static"><?php echo ($SERVER_NAME); ?></p>
					</div>
				</div>
			</div>
		</div>
