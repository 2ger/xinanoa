          ...
          <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
              <ul class="nav navbar-nav">
                ...
                <li class=""><a href="#" url="<?php echo U('customer/index');?>" node="137" onclick="click_top_menu(this)"> <i class="fa fa-users"></i> 客户管理</a></li>
                <!-- <li  class="dropdown">
...
<?php echo W('PageHeader',array('name'=>array('客户信息：',$vo['name']),'search'=>'N'));?>
...
<form method='post' id="form_data" class="form-horizontal well clearfix">
	...
	<div class="form-group col-sm-6">
		<label class="col-sm-4 control-label" >即时聊天：</label>
		<div class="col-sm-8">
			<p class="form-control-static">
				<?php echo ($vo["im"]); ?>
			</p>
...
<script type="text/javascript">
	function edit() {
		window.location = "<?php echo U('edit','id='.$vo['id']);?>";
	}
</script>
