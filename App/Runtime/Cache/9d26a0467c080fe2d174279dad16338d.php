...
<head>
	<meta charset="utf-8" />
	<title><?php echo ($CompanyName['name']); ?> 在线贷款申请书</title>
								...
								<!-- PAGE CONTENT BEGINS -->
                                    ...
                                    <div class="col-sm-12 text-center hidden">
                                       <?php echo W('PageHeader',array('name'=>array('',$flow_type['name']),'search'=>'N'));?>
                                    		...
                                    		<div class="pull-right text-right hidden-print" style="
                                    	    position: absolute;
                                        top: 0px;
                                        right: 20px;">
                                    ...
                                    <form method='post' id="form_data" name="form_data" enctype="multipart/form-data" class=" form-horizontal" style="clear:both"> 
	                                    ...
	                                    <input type="hidden" id="kh" name="kh" value="1">
                                	...
                                	<div class="alert alert-info  " role="alert">
                                				<div class="row">
                                				    ...
                                				    <div class="col-xs-6">
                                                         <strong>企业申请贷款需准备资料（含个人部份所有）</strong>
                                                         <div class="row">
                                                             <div class="col-sm-6">
                                                            12 还款途径相关证明<br/>
                                                            13 公司企业征信报告<br/>
                                                            14 公司营业执照正副本复印件<br/>
                                                            15 公司税务证（国、地税）复印件<br/>
                                                            16 公司组织机构代码复印件
                                    ...
                                    <div class="alert alert-danger alert-dismissible hidden-print" role="alert">
                                      ...
                                      <strong>提示</strong> 请如实填写以下资料，我们的客服尽在24小时内与您联系。<br /> 以上所述材料可预先准备，这将有助你的的贷款办理进度！
                                    </div>
                                    ...
                                    <div class="alert alert-danger text-center  hidden-print" role="alert">
                                    		<a onclick="save(20);"  class="btn btn-lg btn-success"><i class="fa fa-arrow-circle-up"></i> 提交申请</a>
                                                <!-- <a onclick="save(10);"  class="btn  btn-primary"><i class="fa fa-save"></i> 储存草稿</a> -->
                                    </div>
