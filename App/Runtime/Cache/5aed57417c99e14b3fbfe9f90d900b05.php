...
<?php echo W('PageHeader',array('name'=>'幻灯片','search'=>'N'));?>
	...
	<div>
		<div class="ul_table border-bottom">
			<ul>
				<li class="thead">
					<div class="pull-right">
						<span class="col-30 ">链接</span>
						<span class="col-10 text-center">颜色</span>
				...
				<?php if(is_array($list)): foreach($list as $key=>$vo): ?><li class="tbody" node="<?php echo ($vo["id"]); ?>">
						...
						<div class="col-sm-6 profile-picture">
							<img class="img-responsive" src="<?php echo get_save_url(); echo get_file_path($vo['add_file']);?>">
						</div>
						<div class="col-sm-6">
							<span class="col-sm-12"> <a href="<?php echo U('edit','id='.$vo['id']);?>"><?php echo ($vo["name"]); ?></a> </span>
							<span class="col-sm-12"><?php echo ($vo["link"]); ?></span>	
							<span class="col-sm-12 "><?php echo ($vo["color"]); ?>  </span>
							<span class="col-3  text-center"> <a title="调高优先级" class="up"><i class="fa fa-arrow-up"></i></a> </span>							
							<span class="col-3  text-center"> <a title="调低优先级" class="down"><i class="fa fa-arrow-down"></i></a> </span>
							<span class="col-3  text-center"> <a title="删除" class="del" onclick="del(this);"><i class="fa fa fa-times"></i></a> </span>
						</div>						
