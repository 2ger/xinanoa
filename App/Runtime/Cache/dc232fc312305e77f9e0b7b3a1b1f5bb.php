...
<?php echo W('PageHeader',array('name'=>'我受理的贷款'));?>
	...
	<ul>
		<li class="thead" style="padding-left:10px">
			...
			<div class="pull-right">		
				<span  class="col-15  "> 处理人 </span>
				<span  class="col-15  ">用时</span>		
		...
		<form method="post" action="" name="form_data" id="form_data">
			<ul>
				<?php if(is_array($list)): foreach($list as $key=>$vo): ?><li class="tbody">
						...
						<div class="pull-right">
							<span class="col-15   "><?php echo ($vo["stepman"]); ?></span>
							<span class="col-15   "><?php echo (get_days($vo["create_time"])); ?></span>
							<span class="col-15   ">
                        <a href="<?php echo U('flow/dai');?>&id=<?php echo ($vo["id"]); ?>" class="btn btn-success btn-xs">提醒处理人</a>
						 <a href="<?php echo U('flow/dai');?>&id=<?php echo ($vo["id"]); ?>" class="btn btn-danger btn-xs">查看</a>
						 <!-- <a href="<?php echo U('flow/deldai');?>&daiid=<?php echo ($vo["id"]); ?>" class="btn btn-danger btn-xs">删除</a> -->
							</span>
						</div>
						<div class="autocut auto">
						<?php echo (dai_step($vo["nowstep"])); ?> 
