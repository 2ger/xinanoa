...
<body>
	...
	<nav class="navbar navbar-default " role="navigation">
		...
		<button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#navbar-collapse-6">
          ...
          <a class="btn btn-app app-nav btn-xs nav-app active" href="#" url="/liucheng/index.php?m=flow&amp;a=index" node="87" onclick="click_top_menu(this)">
					<i class="fa fa-pencil bc-flow bigger-100"></i>流程																
				</a> 
        </div>
