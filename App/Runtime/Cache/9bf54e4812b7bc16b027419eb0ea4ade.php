...
<?php echo W('PageHeader',array('name'=>'新建日历事项','search'=>'N'));?>
<form method='post' id="form_data" name="form_data" enctype="multipart/form-data"  class="well form-horizontal">
	...
	<div class="form-group col-sm-6">
		...
		<div class="col-sm-8">
			<input data-date-format="yyyy-mm-dd" type="text" id="start_date" name="start_date" readonly="readonly" class="form-control input-date"   check="require" msg="请输入开始日期">
	...
	<div class="form-group col-sm-6">
		...
		<div class="col-sm-8">
			...
			class="form-control input-date" check="require" msg="请输入结束日期">
