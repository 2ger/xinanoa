...
<?php echo W('PageHeader',array('name'=>'贷中'));?>
...
<div class="ul_table">
	<ul>
		<li class="thead" style="padding-left:10px">
			<div class="pull-left">
				<span class="col-16 ">客户</span>
				<span class="col-16 ">申请贷款（元）</span>				
			</div>
			<div class="pull-right">		
				<span  class="col-15  "> 受理人 </span>
				<span  class="col-15  ">已用时</span>		
				<span class="col-15  ">操作</span>
			</div>
		...
		<form method="post" action="" name="form_data" id="form_data">
			<ul>
				<?php if(is_array($list)): foreach($list as $key=>$vo): ?><li class="tbody">
						<div class="pull-left">
							<span class="col-16 "><?php echo ($vo["customer"]); ?> </span>
							<span class="col-16  "> <?php echo ($vo["money"]); ?> </span>
						</div>
						<div class="pull-right">
							<span class="col-15   "><?php echo ($vo["user_name"]); ?></span>
							<span class="col-15   "><?php echo (get_days($vo["create_time"])); ?></span>
							<span class="col-15   ">
                        <a href="<?php echo U('flow/dai');?>&id=<?php echo ($vo["id"]); ?>" class="btn btn-success btn-xs">查看流程</a>
						
						<?php if(($vo["user_name"]) == $user_name): ?><!-- <a href="＃" class="btn btn-danger btn-xs">终止</a> -->
						 <a href="<?php echo U('flow/deldai');?>&daiid=<?php echo ($vo["id"]); ?>" class="btn btn-danger btn-xs">删除</a><?php endif; ?>
						
							</span>
						</div>
						<div class="autocut auto">
						<!-- <?php echo ($vo["what_for"]); ?>  -->
						<?php echo (dai_step($vo["nowstep"])); ?> （<?php echo ($vo["stepman"]); ?>）
