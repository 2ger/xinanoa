...
<?php echo W('PageHeader',array('name'=>'新建工作日报','search'=>'N'));?>
<form method='post' id="form_data" name="form_data" enctype="multipart/form-data"   class="well form-horizontal">
	...
	<table class="table table-bordered">
		<tbody>
			...
			<tr >
				...
				<td>
				<input style="width:100%;" name="row1_2"/>
				</td>
			...
			<tr >
				...
				<td>
				<input style="width:100%;" name="row2_2"/>
				</td>
			...
			<tr >
				...
				<td>
				<input style="width:100%;" name="row3_2"/>
				</td>
			...
			<tr >
				...
				<td>
				<input style="width:100%;" name="row4_2"/>
				</td>
			...
			<tr >
				...
				<td>
				<input style="width:100%;" name="row5_2"/>
				</td>
			...
			<tr >
				...
				<td>
				<input style="width:100%;" name="row6_2"/>
				</td>
			...
			<tr >
				...
				<td>
				<input style="width:100%;" name="row7_2"/>
				</td>
			...
			<tr >
				...
				<td>
				<input style="width:100%;" name="row8_2"/>
				</td>
			...
			<tr >
				...
				<td>
				<input style="width:100%;" name="row9_2"/>
				</td>
			...
			<tr >
				...
				<td>
				<input style="width:100%;" name="row10_2"/>
				</td>
	...
	<table class="table table-bordered">
		<tbody>
			...
			<tr >
				...
				<td class="text-center" >8:00-9:00</td>
				<td>
				<input style="width:100%;" name="row11_2"/>
				</td>
				<td>				<textarea name="row11_3" rows="1" class="autosize-transition" style="width: 100%;"></textarea></td>
				<td>				<textarea name="row11_4"rows="1" class="autosize-transition" style="width: 100%;"></textarea></td>
				<td class="text-center">
				<input name="row11_5" data-date-format="yyyy-mm-dd" class="input-date"/>
				</td>
			</tr>
			<tr >
				<td class="text-center" >2</td>
				...
				<td class="text-center" >9:00-10:00</td>
				<td>
				<input style="width:100%;" name="row12_2"/>
				</td>
				<td>				<textarea name="row12_3" rows="1" class="autosize-transition" style="width: 100%;"></textarea></td>
				<td>				<textarea name="row12_4"rows="1" class="autosize-transition" style="width: 100%;"></textarea></td>
				<td class="text-center">
				<input name="row12_5" data-date-format="yyyy-mm-dd" class="input-date"/>
				</td>
			</tr>
			<tr >
				<td class="text-center" >3</td>
				...
				<td class="text-center" >10:00-11:00</td>
				<td>
				<input style="width:100%;" name="row13_2"/>
				</td>
				<td>				<textarea name="row13_3" rows="1" class="autosize-transition" style="width: 100%;"></textarea></td>
				<td>				<textarea name="row13_4"rows="1" class="autosize-transition" style="width: 100%;"></textarea></td>
				<td class="text-center">
				<input name="row13_5" data-date-format="yyyy-mm-dd" class="input-date"/>
				</td>
			</tr>
			...
			<tr >
				...
				<td class="text-center" >11:00-11:30</td>
				<td>
				<input style="width:100%;" name="row14_2"/>
				</td>
				<td>				<textarea name="row14_3" rows="1" class="autosize-transition" style="width: 100%;"></textarea></td>
				<td>				<textarea name="row14_4"rows="1" class="autosize-transition" style="width: 100%;"></textarea></td>
				<td class="text-center">
				<input name="row14_5" data-date-format="yyyy-mm-dd" class="input-date"/>
				</td>
			</tr>
			<tr >
				<td class="text-center" >5</td>
				...
				<td class="text-center" >13:30-14:30</td>
				<td>
				<input style="width:100%;" name="row15_2"/>
				</td>
				<td>				<textarea name="row15_3" rows="1" class="autosize-transition" style="width: 100%;"></textarea></td>
				<td>				<textarea name="row15_4"rows="1" class="autosize-transition" style="width: 100%;"></textarea></td>
				<td class="text-center">
				<input name="row15_5" data-date-format="yyyy-mm-dd" class="input-date"/>
				</td>
			</tr>
			<tr >
				<td class="text-center" >6</td>
				...
				<td class="text-center" >14:30-15:30</td>
				<td>
				<input style="width:100%;" name="row16_2"/>
				</td>
				<td>				<textarea name="row16_3" rows="1" class="autosize-transition" style="width: 100%;"></textarea></td>
				<td>				<textarea name="row16_4"rows="1" class="autosize-transition" style="width: 100%;"></textarea></td>
				<td class="text-center">
				<input name="row16_5" data-date-format="yyyy-mm-dd" class="input-date"/>
				</td>
			</tr>
			<tr >
				<td class="text-center" >7</td>
				...
				<td class="text-center" >15:30-16:30</td>
				<td>
				<input style="width:100%;" name="row17_2"/>
				</td>
				<td>				<textarea name="row17_3" rows="1" class="autosize-transition" style="width: 100%;"></textarea></td>
				<td>				<textarea name="row17_4"rows="1" class="autosize-transition" style="width: 100%;"></textarea></td>
				<td class="text-center">
				<input name="row17_5" data-date-format="yyyy-mm-dd" class="input-date"/>
				</td>
			</tr>
			<tr >
				<td class="text-center" >8</td>
				...
				<td class="text-center" >16:30-17:30</td>
				<td>
				<input style="width:100%;" name="row18_2"/>
				</td>
				<td>				<textarea name="row18_3" rows="1" class="autosize-transition" style="width: 100%;"></textarea></td>
				<td>				<textarea name="row18_4"rows="1" class="autosize-transition" style="width: 100%;"></textarea></td>
				<td class="text-center">
				<input name="row18_5" data-date-format="yyyy-mm-dd" class="input-date"/>
				</td>
			</tr>
			<tr >
				<td class="text-center" >9</td>
				...
				<td class="text-center" >17:30-18:00</td>
				<td>
				<input style="width:100%;" name="row19_2"/>
				</td>
				<td>				<textarea name="row19_3" rows="1" class="autosize-transition" style="width: 100%;"></textarea></td>
				<td>				<textarea name="row19_4"rows="1" class="autosize-transition" style="width: 100%;"></textarea></td>
				<td class="text-center">
				<input name="row19_5" data-date-format="yyyy-mm-dd" class="input-date"/>
				</td>
			</tr>
			<tr >
				<td class="text-center" >10</td>
				...
				<td class="col-10" >18:00</td>
				<td>
				<input style="width:100%;" name="row20_2"/>
				</td>
				<td>				<textarea name="row20_3" rows="1" class="autosize-transition" style="width: 100%;"></textarea></td>
				<td>				<textarea name="row20_4"rows="1" class="autosize-transition" style="width: 100%;"></textarea></td>
				<td class="text-center">
				<input name="row20_5" data-date-format="yyyy-mm-dd" class="input-date"/>
				</td>
			</tr>
			<tr height="0" style="visibility:hidden;">
				<td width="45" style="width: 34pt;"></td>
	...
	<table class="table table-bordered">
		<tbody>
			...
			<tr>
				<td class="text-center">
				<input name="row24_1" class="col-3 text-center"/>
				</td>
				<td class="text-center">
				<input name="row24_2" class="col-3 text-center"/>
				</td>
				<td class="text-center">
				<input name="row24_3" class="col-3 text-center"/>
				</td>
				<td class="text-center">
				<input name="row24_4" class="col-3 text-center"/>
				</td>
				<td class="text-center">
				<input name="row24_5" class="col-3 text-center"/>
				</td>
				<td class="text-center">
				<input name="row24_6" class="col-3 text-center"/>
				</td>
				<td class="text-center">
				<input name="row24_7" class="col-3 text-center"/>
				</td>
				<td class="text-center">
				<input name="row24_8" class="col-3 text-center"/>
				</td>
				<td class="text-center">
				<input name="row24_9" class="col-3 text-center"/>
				</td>
			</tr>
			<tr >
			...
			<tr >
				...
				<td colspan="8">				<textarea name="row26_1" rows="2" class="autosize-transition" style="width: 100%;"></textarea></td>
			</tr>
			<tr >
				<td class="text-center">今日事项推进过程中遇到的问题和困难</td>
				<td colspan="8">				<textarea name="row27_1" rows="2" class="autosize-transition" style="width: 100%;"></textarea></td>
			</tr>
