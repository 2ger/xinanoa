...
<?php echo W('PageHeader',array('name'=>'编辑系统参数','search'=>'N'));?>
<div class="operate panel panel-default">
	<div class="panel-body">
		<div class="pull-left">
...
<form method='post' id="form_data" action="<?php echo U('update');?>" class="well form-horizontal">
	<table class="table table-bordered">
		...
		<div class="form-group col-xs-12">
			...
			<div class="col-sm-8">
				<input class="form-control" value="<?php echo ($vo["code"]); ?>" type="text" id="code" name="code" check="require" msg="请输入代码">
			</div>
		</div>
		<div class="form-group col-xs-12">
			<label class="col-sm-4 control-label" for="name">名称*：</label>
			<div class="col-sm-8">
				<input class="form-control" value="<?php echo ($vo["name"]); ?>" type="text" id="name" name="name" check="require" msg="请输入名称">
			</div>
		</div>
		...
		<div class="form-group col-xs-12">
			...
			<div class="col-sm-8">
				<input class="form-control" value="<?php echo ($vo["val"]); ?>" type="text" id="val" name="val" check="require" msg="请输入数据">
			</div>
		</div>
		<div class="form-group col-xs-12">
			<label class="col-sm-4 control-label" for="sort">排序：</label>
			<div class="col-sm-8">
				<input class="form-control" value="<?php echo ($vo["sort"]); ?>" type="text" id="sort" name="sort" >
			</div>
		</div>
		<div class="form-group col-xs-12">
