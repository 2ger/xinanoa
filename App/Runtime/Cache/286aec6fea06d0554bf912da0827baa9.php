...
<?php echo W('PageHeader',array('name'=>'职级管理','search'=>'S'));?>
<div class="operate panel panel-default">
	<div class="panel-body">
	...
	<div class="col-sm-8 sub_content">
		<form id="form_data" name="form_data" method="post" class="well form-horizontal clearfix">
			...
			<div class="form-group col-xs-12">
				<label class="col-sm-4 control-label" for="rank_no">编码*：</label>
				<div class="col-sm-8">
					<input class="form-control" type="text" id="rank_no" name="rank_no" check="require" msg="请输入编号">
				</div>
			</div>
