...
<?php echo W('PageHeader',array('name'=>'新建幻灯片','search'=>'N'));?>
<form method='post' id="form_data" name="form_data" enctype="multipart/form-data"   class="well form-horizontal">
	...
	<div class="form-group">
		...
		<div class="col-sm-10">
			<input value="<?php echo ($vo["link"]); ?>" class="form-control" type="text" id="link" name="link" check="require" msg="请输入链接">
		</div>
	</div>	

	<div class="form-group col-sm-6">
		<label class="col-sm-4 control-label" for="color">颜色：</label>
		<div class="col-sm-8">
			<input type="text" id="color" name="color"  class="form-control" value="">
		</div>
	</div>
	<div class="form-group col-sm-6">
		<label class="col-sm-4 control-label" for="color">排序：</label>
		<div class="col-sm-8">
			<input type="text" id="color" name="color"  class="form-control" value="">
		</div>
	</div>
