...
<?php echo W('PageHeader',array('name'=>'公告搜索','search'=>'M'));?>
	...
	<ul>
		...
		<?php if(empty($list)): ?><li class="no-data">
			...
			<form method="post" action="" name="form_data" id="form_data">
				<?php if(is_array($list)): foreach($list as $key=>$vo): ?><li class="tbody <?php if((!in_array($vo['id'],$readed_id))&&($vo['create_time']>time()-3600*8*24)) echo("bold") ?>"">
						<div class="pull-left">
							<span class="col-10 "><?php echo ($vo["notice_no"]); ?></span>
							<span class="col-10  autocut"><?php echo ($vo["folder_name"]); ?></span>
						</div>
					<div class="pull-right">
