...
<?php echo W('PageHeader',array('name'=>$folder_name));?>

<div class="ul_table">
	<ul>
		<li class="thead" style="padding-left:10px">
			<div class="pull-left">
				<span class="col-12 ">客户 <?php echo ($notice); ?></span>
				<span class="col-12 ">贷款金额(元)</span>				
			</div>
			<div class="pull-right">
				<span  class="col-12  ">类型</span>				
				<span  class="col-12  "> 抵压物</span>
				<span class="col-12  ">归档时间</span>
			</div>
		...
		<form method="post" action="" name="form_data" id="form_data">
			<ul>
				<?php if(is_array($list)): foreach($list as $key=>$vo): ?><li class="tbody">
						<div class="pull-left">
							<span class="col-12 "><a href="index.php?m=flow&a=read&customer=1&id=<?php echo ($vo["flow_id"]); ?>"><?php echo (get_cus_name($vo["flow_id"])); ?></a></span>
							<span class="col-12"> <?php echo (get_cus_money($vo["flow_id"])); ?></span>
						</div>
						<div class="pull-right">
							<span class="col-12   "> <?php echo (get_cus_type($vo["flow_id"])); ?></span>
							<span class="col-12   "><?php echo (get_cus_dy($vo["flow_id"])); ?></span>
							<span class="col-12   "><?php echo (todate(get_cus_date($vo["flow_id"]),'Y-m-d')); ?></span>
						</div>
						<div class="autocut auto">
						    <?php echo (get_cus_hy($vo["flow_id"])); ?>
						</div>
