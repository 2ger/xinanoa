...
<?php echo W('PageHeader',array('name'=>'受理客户申请'));?>

<div class="ul_table">
	<ul>
		<li class="thead" style="padding-left:10px">
			<div class="pull-left">
				<span class="col-16 ">提交时间  <?php echo ($create_date); ?> </span>
				<span class="col-16 ">客户</span>				
			</div>
			<div class="pull-right">		
				<span  class="col-10  "> 申请贷款（元） </span>
		...
		<form method="post" action="" name="form_data" id="form_data">
			<ul>
				<?php if(is_array($list)): foreach($list as $key=>$vo): ?><li class="tbody">
						<div class="pull-left">
							<span class="col-16 "> <?php echo (todate($vo["create_time"],'Y-m-d h:i')); ?></span>
							<span class="col-16  "> <?php echo (get_customer_name_46($vo["id"])); ?> </span>
						</div>
						<div class="pull-right">
							<span class="col-10   "><?php echo (get_customer_money_46($vo["id"])); ?></span>
							<span class="col-10   "><?php echo (get_customer_tel_46($vo["id"])); ?></span>
							<span class="col-10   "> <a href="<?php echo U('flow/adddai');?>&flowid=<?php echo ($vo["id"]); ?>" class="btn btn-success btn-xs">受理</a>
						 <a href="<?php echo U('flow/del');?>&flowid=<?php echo ($vo["id"]); ?>" class="btn btn-danger btn-xs">删除</a>
							</span>
						</div>
						<div class="autocut auto">
						<?php echo (get_customer_for_46($vo["id"])); ?> 
