...
<?php echo W('PageHeader',array('name'=>'待办事项'));?> <?php echo ($listcount); ?>
		...
		<form method="post" action="" name="form_data" id="form_data">
			<ul>
				<?php if(is_array($list)): foreach($list as $key=>$vo): ?><li class="tbody">
						...
						<div class="pull-right">
							<span class="col-15   "><?php echo (dai_step($vo["nowstep"])); ?> </span>
							<span class="col-15   "><?php echo (get_days($vo["create_time"])); ?></span>
							<span class="col-15   ">
                        <a href="<?php echo U('flow/dai');?>&id=<?php echo ($vo["id"]); ?>" class="btn btn-success btn-xs">去处理</a>
						 <!-- <a href="<?php echo U('flow/dai');?>&id=<?php echo ($vo["id"]); ?>" class="btn btn-danger btn-xs">归案</a> -->
							</span>
						</div>
						<div class="autocut auto">
