...
<form method='post' id="form_data" class="well form-horizontal">
	...
	<div class="form-group col-sm-6">
		...
		<div class="col-sm-8">
			<input class="form-control" type="text" id="doc_no_format" value="{YYYY}{M}{D}{####}" name="doc_no_format" check="require" msg="请输入编号规则">
		</div>
	</div>
	...
	<div class="form-group col-sm-6">
		<label class="col-sm-4 control-label" for="is_edit">提示信息：</label>
		<div class="col-sm-8">
