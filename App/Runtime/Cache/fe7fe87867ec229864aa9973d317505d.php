...
<?php echo W('PageHeader',array('name'=>'VIP','search'=>'M'));?>
				...
				<?php if(is_array($list)): foreach($list as $key=>$vo): ?><li class="tbody">
						<div class="row">
							...
							<label class="inline pull-left col-3">
								...
								<nobr>
									<?php echo ($vo["area"]); ?>
								<?php if(!empty($vo["active_shop"])): ?>- <?php echo ($vo["active_shop"]); ?>&nbsp;<?php endif; ?>
								</nobr>
							</div>
							<div class="col-sm-6 col-xs-12" >								
								<a style="padding-left:30px;" href="<?php echo U('edit','id='.$vo['id']);?>" class="data wrap"><?php echo ($vo["name"]); ?>-<?php echo ($vo["vip_type"]); ?></a>
							</div>
						</div>
						<div class="row">
							<div  class="col-sm-6 col-xs-12" >
							...
							<div  class="col-sm-6 col-xs-12">
								<nobr style="padding-left:30px;">
									<a href="<?php echo U('sales','vip_id='.$vo['id']);?>" class="data wrap">消费记录</a>
								</nobr>
							</div>
						</div>
